...
public class ProductInventoryAspect {
    ...
    @Before("execution(* com.barbosa.ms.productinventory.productinventory.services.*.* (..))")
    ...
    @AfterReturning(pointcut = "execution(* com.barbosa.ms.productinventory.productinventory.services.*.* (..))", returning = "result")
