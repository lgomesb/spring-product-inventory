...
@Aspect
@Component
public class ProductInventoryAspect {
    
        private final Logger logger = LoggerFactory.getLogger(this.getClass());

    @Before("execution(* com.barbosa.ms.productinventory.product-inventory.services.*.* (..))")
    ...
    @AfterReturning(pointcut = "execution(* com.barbosa.ms.productinventory.product-inventory.services.*.* (..))", returning = "result")
